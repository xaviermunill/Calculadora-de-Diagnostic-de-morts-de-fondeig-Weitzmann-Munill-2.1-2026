...
export async function exportMapAndTableToPdf({
  ...
  doc.text('DIRECCIÓ GENERAL DE POLÍTIQUES MARÍTIMES I PESCA SOSTENIBLE • PROTOCOL DE DIAGNOSI DE MORTS', margin, margin + 9.5);
  ...
  doc.setFontSize(8);
  doc.setTextColor(61, 90, 69);
  doc.text('GENERALITAT DE CATALUNYA • INVENTARI OFICIAL DE MORTS I FONDEJOS', margin, margin + 6);
