...
export function generateMailtoUrl(
  ...
  const bodyText = `
ACTA DE REGISTRE I DIAGNOSI: MORTS DE FONDEIG (v3.0 - 2026)
...
- C2 (Substrat & Impacte): ${record.c2_substrateImpact} (Elements mòbils: ${record.c2_hasMobileElements ? `Sí, superfície d'abrasió: ${(record.c2_abrasionAreaM2 ?? record.c2_haloRadiusM ?? 0)} m²` : 'No'})
