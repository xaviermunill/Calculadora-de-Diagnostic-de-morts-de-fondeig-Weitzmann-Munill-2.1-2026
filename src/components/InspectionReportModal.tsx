...
import { Printer, X, ShieldCheck, AlertTriangle, AlertOctagon, CheckCircle2, Waves, Anchor, Scale, SearchX, Camera, Mail, Loader2, CheckCircle, Sparkles } from 'lucide-react';
                        ...
                        <tr>
                          ...
                          <td className="p-2.5 text-[#5C6B5E]">
                            {b.c2_substrateImpact === 'active_erosion_halo'
                              ? `Ferida/calva activa (Radi: ${b.c2_haloRadiusM || 0} m)`
