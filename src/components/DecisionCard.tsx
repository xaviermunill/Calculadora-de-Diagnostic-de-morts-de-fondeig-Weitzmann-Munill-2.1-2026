  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#134E4A] text-white p-7 sm:p-8 rounded-3xl flex flex-col items-center justify-center text-center shadow-lg border border-[#0f3e3b] relative overflow-hidden">
        ...
        <div className="flex items-center gap-2 text-xs uppercase tracking-[0.2em] opacity-80 mb-2 font-mono">
          {getStatusIcon()}
        ...
        <div className="text-[10px] text-white/80 mt-3 flex items-center justify-center gap-1.5 font-sans">
          <Mail className="w-3.5 h-3.5 text-teal-200 shrink-0" />
          <span>En registrar el punt s'envia per correu a <strong>xaviermunill@bufalvent.net</strong></span>
        </div>
      </div>
      ...
      <div className="bg-[#E9E9E0] p-6 rounded-3xl border border-[#DCDCD2] space-y-4">
        <h3 className="text-xs font-bold uppercase tracking-widest text-[#134E4A] border-b border-[#D1D1C7] pb-2 flex items-center justify-between">
          <span>Matriu Oficial de Decisions</span>
