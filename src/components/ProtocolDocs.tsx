...
import { Matrix128Explorer } from './Matrix128Explorer';
...
export const ProtocolDocs: React.FC = () => {
  return (
    <div className="max-w-5xl mx-auto space-y-10 pb-16">
          ...
          <div className="p-6 rounded-3xl bg-[#EBF3ED] border border-[#C5DDCB] space-y-3">
            <div className="flex items-center justify-between">
              <h3 className="font-serif font-bold text-[#1A4526] flex items-center gap-2 text-sm sm:text-base">
                ...
                Criteri 1: Protecció d'espècies amenaçades o hàbitats protegits (-12 a 0 punts)
              </h3>
            ...
            <ul className="text-xs text-[#1A4526] list-disc list-inside space-y-1.5 pt-1">
              <li><strong>Recobriment &gt;10% o exemplars reproductors d'espècies protegides:</strong> -12 punts</li>
              <li><strong>Presència d'espècies amenaçades en densitats &lt;10%:</strong> -8 punts</li>
              <li><strong>Recobriment algal general o organismes renaturalitzats:</strong> -4 punts</li>
          ...
          <div className="p-6 rounded-3xl bg-[#FBF0EE] border border-[#EDC5C0] space-y-3">
            <div className="flex items-center justify-between">
              <h3 className="font-serif font-bold text-[#6B221D] flex items-center gap-2 text-sm sm:text-base">
                ...
                Criteri 2: Impacte sobre el substrat annex (+6 a 0 punts)
              </h3>
            ...
            <ul className="text-xs text-[#6B221D] list-disc list-inside space-y-1.5 pt-1">
              <li><strong>Existeix ferida o calva activa a la praderia (halo) o elements mòbils:</strong> +6 punts</li>
          ...
          <div className="p-6 rounded-3xl bg-[#EAF0F4] border border-[#BFD4E2] space-y-3">
            <div className="flex items-center justify-between">
              <h3 className="font-serif font-bold text-[#133E59] flex items-center gap-2 text-sm sm:text-base">
                ...
                Criteri 3: Dinamisme i Risc — Tamany i Fondària (+4 a 0 punts)
              </h3>
            ...
            <p className="text-xs sm:text-sm text-[#133E59] leading-relaxed">
              <strong>Justificació ecològica i física:</strong> Blocs de pes reduït sotmesos a onatge i corrents a diferents fondàries. Segons el lliscament crític (u_b), es divideix en 4 nivells de risc:
            </p>
            <ul className="text-xs text-[#133E59] list-disc list-inside space-y-1.5 pt-1">
              <li><strong>Risc Alt (Blau - Bloc petit en zona somera amb alta mobilitat):</strong> +4 punts</li>
              <li><strong>Risc Mitjà-Alt (Verd - Mobilització en temporals forts):</strong> +2 punts</li>
              <li><strong>Risc Baix (Taronja - Mobilitat només en temporals extrems):</strong> +1 punt</li>
              <li><strong>Absència de risc (Vermell - Gran estabilitat per inèrcia o fondària):</strong> 0 punts</li>
            </ul>
          </div>
          ...
          <div className="p-6 rounded-3xl bg-[#FAF9F6] border border-[#D1D1C7] space-y-3">
            <div className="flex items-center justify-between">
              <h3 className="font-serif font-bold text-[#134E4A] flex items-center gap-2 text-sm sm:text-base">
                ...
                Criteri 4: Estabilitat i Integració en l'hàbitat (-12 a +8 punts)
              </h3>
            ...
            <p className="text-xs sm:text-sm text-[#134E4A] leading-relaxed">
              <strong>Justificació ecològica:</strong> Blocs integrats, enterrats o arrelats en la mata de <em>Posidonia</em>. La seva extracció pot obrir una ferida a la mata que podria derivar en marmites d'erosió o colonització per invasores.
            </p>
            <ul className="text-xs text-[#134E4A] list-disc list-inside space-y-1.5 pt-1">
              <li><strong>Bloc lliure, no toca posidònia, no genera espai buit:</strong> +8 punts</li>
              <li><strong>Enfonsament parcial, no toca posidònia, no genera espai buit:</strong> +4 punts</li>
              <li><strong>Bloc no enterrat, sí genera un espai buit nou:</strong> -6 punts</li>
              <li><strong>Bloc fixat per les pròpies arrels de Posidònia (mata cohesionada):</strong> -12 punts</li>
            </ul>
          </div>
      ...
      {/* 3.1 Explorador Interactiu de les 128 Casuístiques */}
      <Matrix128Explorer />
